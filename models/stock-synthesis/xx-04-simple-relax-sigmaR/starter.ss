...
2 10 #_min and max age over which mean F will be calculated with F_reporting=4 or 5
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1737661561
