...
#C file write time: 2025-01-10  06:47:17
data.ss
control.ss
...
-1 # min year for sdreport outputs (-1 for styr); #_1977
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1736529021
