  ...
  body = dashboardBody(
    ...
    tabItems(
      ...
      tabItem(tabName="introduction", h2("Introduction"),
        fluidRow(column(12, includeMarkdown(file.path(proj_dir,"code","shiny","introduction_index.md"))))
      ...
      tabItem(tabName="catch_plots", h2("Catch plots"),
        fluidRow(
          box(title="Total catch", solidHeader=TRUE, collapsible=TRUE, collapsed=start_collapsed, status="primary", width=12,
            p("Select at least one model."),
      ...
      tabItem(tabName="cpue_plots", h2("CPUE plots"),
        fluidRow(
          box(title="Observed CPUE", solidHeader=TRUE, collapsible=TRUE, collapsed=start_collapsed, status="primary", width=12,
            p("Select at least one model."),
