...
# 2025/01/23
# Sensitivity to CV for early catch
...
# transfer files
    ...
    to_dir = file.path(dir_model,"stock-synthesis","18-CAAL-cUnc-cv40")
...
#________________________________________________________________________________________________________________________________________________________________________________________________________
# modify files; data
# increase CV on early catch
        tmp_catch = as.data.table(tmp_data$catch) %>%
                    .[fleet==15&catch>0&seas%in%3:4,catch_se:=0.4] %>%
                    .[fleet==15&catch>0&seas%in%1:2,catch_se:=0.1] %>%
